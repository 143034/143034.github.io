...
export default function SettingsModal({onClose,
  ...
  const clampedWidth = Math.min(screenMaxWidth, Math.max(600, Number(containerWidth) || 1200));
  const pageWidthPercent = ((clampedWidth - 600) / (screenMaxWidth - 600)) * 100;
  ...
  const updateWidthByClientX = (clientX) => {
    ...
    const rawWidth = 600 + clampedRatio * (screenMaxWidth - 600);
